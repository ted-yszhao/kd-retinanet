...
\draw[->] (input.east) -- ++(0.8,0) |- (tback.west);
\draw[->] (tback) -- (tfpn);
...
\draw[->] (input.east) -- ++(0.8,0) |- (sback.west);
\draw[->] (sback) -- (sfpn);
...
\draw[->] (sfpn.east) -- ++(0.9,0) |- (head.west);
...
\draw[->] (tfpn.east) -- ++(0.8,0) |- (tp3.west);
\draw[->] (tfpn.east) -- ++(0.8,0) |- (tp4.west);
\draw[->] (tfpn.east) -- ++(0.8,0) |- (tp5.west);
\draw[->] (tfpn.east) -- ++(0.8,0) |- (tp6.west);
\draw[->] (tfpn.east) -- ++(0.8,0) |- (tp7.west);
...
\draw[->] (sfpn.east) -- ++(0.8,0) |- (sp3.west);
\draw[->] (sfpn.east) -- ++(0.8,0) |- (sp4.west);
\draw[->] (sfpn.east) -- ++(0.8,0) |- (sp5.west);
\draw[->] (sfpn.east) -- ++(0.8,0) |- (sp6.west);
\draw[->] (sfpn.east) -- ++(0.8,0) |- (sp7.west);
...
\draw[->] (tp4.east) -- (align4.west);
\draw[->] (sp4.east) -- ++(0.8,0) |- (align4.south west);
\draw[->] (tp5.east) -- ++(0.8,0) |- (align5.north west);
\draw[->] (sp5.east) -- (align5.west);
...
\draw[->] (avg4.east) -- (ssimblk4.west);
\draw[->] (ssimblk4.east) -- (pool4.west);
\draw[->] (pool4.east) -- (lvl4.west);
...
\draw[->] (avg5.east) -- (ssimblk5.west);
\draw[->] (ssimblk5.east) -- (pool5.west);
\draw[->] (pool5.east) -- (lvl5.west);
...
\draw[->] (lvl4.east) -- ++(0.9,0) |- ([yshift=1.5mm]sum.west);
\draw[->] (lvl5.east) -- ++(0.9,0) |- ([yshift=-1.5mm]sum.west);
\draw[->] (etc.east) -- ++(1.0,0) |- (sum.south west);
...
\draw[->] (sum) -- (total);
\draw[->] (det) -- (total);
\draw[->] (head.east) -- ++(2.4,0) |- (det.west);

\draw[->, dashed, red!80!black, line width=0.95pt] (total.west) -- ++(-1.6,0) |- ([xshift=1mm]head.east);
\draw[->, dashed, red!80!black, line width=0.95pt] ([xshift=-1mm]head.west) -- ++(-1.2,0) |- ([xshift=1mm]sfpn.east);
\draw[->, dashed, red!80!black, line width=0.95pt] (sum.west) -- ++(-1.4,0) |- ([xshift=1mm]sp4.east);
\draw[->, dashed, red!80!black, line width=0.95pt] (sum.west) -- ++(-1.4,0) |- ([xshift=1mm]sp5.east);
